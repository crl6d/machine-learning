...
#Note1: a negative or zero value for a step will call the infinite loop and so please do not select it. Only numbers are allowerd.
#Note2: Start position should be smaller then end position
#Note3: Eps must always be higher then 0
#Exemple input format: 0 ; 5 ; 0.5 ; 3
